...
#3. #3. Consider if statement as a paragraph, elif are the sub paragraph within it, if you change elif to if, its like you are taking it out of the paragraph, so it will print our "tie" becasue it is a condition that is other than team_b_points larger than team_a_point
